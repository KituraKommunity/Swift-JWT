...
<a href="https://travis-ci.org/KituraKommunity/Swift-JWT">
<img src="https://travis-ci.org/KituraKommunity/Swift-JWT.svg?branch=master" alt="Build Status - Master">
</a>
...
#### Add dependencies
Add the `Swift-JWT` package to the dependencies within your application’s `Package.swift` file. Substitute `"x.x.x"` with the latest `Swift-JWT` [release](https://github.com/KituraKommunity/Swift-JWT/releases).
```swift
.package(url: "https://github.com/KituraKommunity/Swift-JWT.git", from: "x.x.x")
```
...
For details on creating elliptic curve public and private keys, view the [BlueECC README.txt](https://github.com/KituraKommunity/BlueECC).
...
## License
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/KituraKommunity/Swift-JWT/blob/master/LICENSE).
